...
const Container = () => {
  ...
  return (
    <div ref={containerRef} className='grow relative flex flex-col bg-dark-200 overflow-y-auto'>
      <div className='sticky top-0 flex justify-between pt-4 px-12 pb-2 leading-[56px] bg-dark-200 z-10 flex-wrap gap-y-2'>
        <TabSliderNew
          value={activeTab}
