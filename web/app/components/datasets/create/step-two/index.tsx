                ...
                >
                  ...
                  <div className={cn(s.typeHeader)}>
                    ...
                    <div className='pb-0.5 text-xs font-medium text-gray-500'>{t('datasetCreation.stepTwo.emstimateCost')}</div>
                    {
                      estimateTokes
                        ? (
                          <div className='text-xs font-medium text-gray-100'>{formatNumber(estimateTokes.tokens)} tokens(<span className='text-yellow-500'>${formatNumber(estimateTokes.total_price)}</span>)</div>
                        )
                        : (
              ...
              {(!hasSetIndexType || (hasSetIndexType && indexingType === IndexingType.ECONOMICAL)) && (
                ...
                >
                  ...
                  <div className={s.typeHeader}>
                    ...
                    <div className='pb-0.5 text-xs font-medium text-gray-500'>{t('datasetCreation.stepTwo.emstimateCost')}</div>
                    <div className='text-xs font-medium text-gray-100'>0 tokens</div>
                  </div>
                </div>
              )}
            </div>
