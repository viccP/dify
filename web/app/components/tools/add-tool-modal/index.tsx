  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className='relative shrink-0 w-[200px] pb-3 bg-gray-101 rounded-l-xl border-r-[0.5px] border-black/2 overflow-y-auto'>
            <div className='sticky top-0 left-0 right-0'>
              <div className='sticky top-0 left-0 right-0 px-5 py-3 text-md font-semibold text-gray-100'>{t('tools.addTool')}</div>
