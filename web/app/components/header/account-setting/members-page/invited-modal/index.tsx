  ...
  return (
    <div className={s.wrap}>
      <Modal isShow onClose={() => { }} className={s.modal} wrapperClassName='z-20'>
        ...
        <div className='mb-1 text-xl font-semibold text-gray-100'>{t('common.members.invitationSent')}</div>
        {!IS_CE_EDITION && (
            ...
            <div className='flex flex-col gap-2 mb-9'>
              {
                ...
                && <>
                  <div className='py-2 text-sm font-Medium text-gray-100'>{t('common.members.invitationLink')}</div>
              ...
              }
              {
                ...
                && <>
                  <div className='py-2 text-sm font-Medium text-gray-100'>{t('common.members.failedinvitationEmails')}</div>
