    ...
    <div className='relative flex flex-col h-full overflow-hidden'>
      <div className='flex items-center justify-between flex-shrink-0 px-6 border-b border-solid py-2 border-b-gray-100'>
        ...
        <div className='flex items-center flex-wrap gap-y-1'>
          ...
          <div className={`flex items-center h-9 px-3 rounded-lg  border border-dark-15
                        text-[13px] font-normal  mr-2 ${appDetail.enable_api ? 'text-green-500 bg-dark-120' : 'text-yellow-500 bg-dark-120'}`}>
