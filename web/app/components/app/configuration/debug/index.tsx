    ...
    <>
      <div className="shrink-0 pt-4 px-6">
        <div className='flex items-center justify-between mb-2'>
          <div className='h2 !text-dark-0'>{t('appDebug.inputs.title')}</div>
