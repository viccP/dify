      ...
      <div className={'mt-3 px-4 bg-white border border-dark-220'}>
        <div className={
          ...
          <div className='flex items-center space-x-1 cursor-pointer' onClick={() => setUserInputFieldCollapse(!userInputFieldCollapse)}>
            ...
            <div className='text-xs font-medium text-gray-100 uppercase'>{t('appDebug.inputs.userInputField')}</div>
          </div>
          ...
          <>
            {
              promptVariables.length > 0
                ...
                : (
                  <div className='text-xs text-gray-501'>{t('appDebug.inputs.noVar')}</div>
                )
            }
            {
