const translation = {
  ...
  welcome: 'Ласкаво просимо до Bonc LOps , будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском Bonc LOps  Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда Bonc LOps ',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте Bonc LOps ',
