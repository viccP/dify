const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Або спробуйте хмарну версію Bonc LOps  з безкоштовною квотою', // Or try the cloud version ...
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Допомагає відвідувачам зрозуміти, які дані збирає програма. Дивіться <privacyPolicyLink>Політику конфіденційності</privacyPolicyLink> Bonc LOps .',
        },
      },
      embedded: {
        ...
        chromePlugin: 'Встановити розширення Bonc LOps  Chatbot для Chrome',
