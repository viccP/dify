const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Airita account',
    langGeniusAccountTip: 'Your Airita account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Airita to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Airita allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Airita\'s applications.',
    link: 'Learn how to develop your own API Extension.',
    linkUrl: 'https://docs.Airita.ai/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'Airita {{version}} is now available.',
    latestAvailable: 'Airita {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
