const translation = {
  ...
  welcome: 'Welcome to Bonc LOps , please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Bonc LOps  Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Bonc LOps ',
  invalid: 'The link has expired',
  explore: 'Explore Bonc LOps ',
