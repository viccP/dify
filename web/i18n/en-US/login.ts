const translation = {
  ...
  welcome: '👋 Welcome to Airita, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Airita Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Airita',
  invalid: 'The link has expired',
  explore: 'Explore Airita',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Airita and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Airita Enterprise license for your workspace has expired. Please contact your administrator to continue using Airita.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Airita license server. Please contact your administrator to continue using Airita.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Airita Enterprise license for your workspace is inactive. Please contact your administrator to continue using Airita.',
}
