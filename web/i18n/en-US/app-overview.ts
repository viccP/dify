const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Or try the cloud version of Airita with free quote',
  },
  overview: {
    title: 'Overview',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see Airita\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Install Airita Chatbot Chrome Extension',
        copied: 'Copied',
        copy: 'Copy',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          name: 'Fork the client code, moAirita it and deploy to Vercel (recommended)',
          step1: 'Fork the client code and moAirita it',
          step1Tip: 'Click here to fork the source code into your GitHub account and moAirita the code',
          step1Operation: 'Airita-WebClient',
