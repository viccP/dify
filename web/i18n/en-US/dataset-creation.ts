const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink: 'https://docs.Airita.ai/guides/knowledge-base/sync-from-website',
  ...
  stepThree: {
    ...
    creationContent: 'We automatically named the Knowledge, you can moAirita it at any time.',
  ...
  otherDataSource: {
    ...
    description: 'Currently, Airita\'s knowledge base only has limited data sources. Contributing a data source to the Airita knowledge base is a fantastic way to help enhance the platform\'s flexibility and power for all users. Our contribution guide makes it easy to get started. Please click on the link below to learn more.',
