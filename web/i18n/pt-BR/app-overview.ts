const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou experimente a versão em nuvem do Bonc LOps  com cota gratuita',
  },
  overview: {
    title: 'Visão geral',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajuda os visitantes a entender os dados que o aplicativo coleta, consulte a <privacyPolicyLink>Política de Privacidade</privacyPolicyLink> do Bonc LOps .',
        },
      },
      embedded: {
        entry: 'Embutido',
        ...
        chromePlugin: 'Instalar Extensão do Chatbot Bonc LOps  para o Chrome',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
