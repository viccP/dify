const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Conta BoncLops',
    langGeniusAccountTip: 'Sua conta BoncLops e dados de usuário associados.',
  ...
  members: {
    ...
    invitationSentTip: 'Convite enviado e eles podem fazer login no BoncLops para acessar os dados da sua equipe.',
  ...
  apiBasedExtension: {
    title: 'As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da Bonc Lops.',
